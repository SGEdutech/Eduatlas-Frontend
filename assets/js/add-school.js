...
function monday(isOffice) {
    ...
    if(isOffice) {
        ...
        if (OcboxMon.checked) {
            ...
            document.getElementById('OmonFrom').innerHTML = `<input type="text" name="n_dayAndTimeOfOperation_day_1" value="monday" class="hide">
                        <input name="n_dayAndTimeOfOperation_fromTime_1" type="text" class="timepicker col s5"
                               placeholder="Start" required>`;
        }
        if (OcboxMon.checked) {
            ...
            document.getElementById('OmonTo').innerHTML = `<input name="n_dayAndTimeOfOperation_toTime_1" type="text" class="timepicker col s5" placeholder="End"
                               required>`;
        }
    }
...
function tuesday(isOffice) {
    if (isOffice) {
        ...
        if (OcboxTues.checked) {
            ...
            document.getElementById('OtueFrom').innerHTML = `<input type="text" name="n_dayAndTimeOfOperation_day_2" value="tuesday" class="hide">
                        <input name="n_dayAndTimeOfOperation_fromTime_2" type="text" class="timepicker col s5"
                               placeholder="Start" required>`;
        }
        if (OcboxTues.checked) {
            ...
            document.getElementById('OtueTo').innerHTML = `<input name="n_dayAndTimeOfOperation_toTime_2" type="text" class="timepicker col s5" placeholder="End"
                               required>`;
        }
    }
    $('.timepicker').timepicker();
...
function wednesday(isOffice) {
    if (isOffice) {
        ...
        if (OcboxWed.checked) {
            ...
            document.getElementById('OwedFrom').innerHTML = `<input type="text" name="n_dayAndTimeOfOperation_day_3" value="wednesday" class="hide">
                        <input name="n_dayAndTimeOfOperation_fromTime_3" type="text" class="timepicker col s5"
                               placeholder="Start" required>`;
        }
        if (OcboxWed.checked) {
            ...
            document.getElementById('OwedTo').innerHTML = `<input name="n_dayAndTimeOfOperation_toTime_3" type="text" class="timepicker col s5"
                               placeholder="End" required>`;
        }
    }
    $('.timepicker').timepicker();
...
function thursday(isOffice) {
    if (isOffice) {
        ...
        if (OcboxThr.checked) {
            ...
            document.getElementById('OthrFrom').innerHTML = `<input type="text" name="n_dayAndTimeOfOperation_day_4" value="thursday" class="hide">
                        <input name="n_dayAndTimeOfOperation_fromTime_4" type="text" class="timepicker col s5"
                               placeholder="Start" required>`;
        }
        if (OcboxThr.checked) {
            ...
            document.getElementById('OthrTo').innerHTML = `<input name="n_dayAndTimeOfOperation_toTime_4" type="text" class="timepicker col s5"
                               placeholder="End" required>`;
        }
    }
    $('.timepicker').timepicker();
...
function friday(isOffice) {
    if (isOffice) {
        ...
        if (OcboxFri.checked) {
            ...
            document.getElementById('OfriFrom').innerHTML = `<input type="text" name="n_dayAndTimeOfOperation_day_5" value="friday" class="hide">
                        <input name="n_dayAndTimeOfOperation_fromTime_5" type="text" class="timepicker col s5"
                               placeholder="Start" required>`;
        }
        if (OcboxFri.checked) {
            ...
            document.getElementById('OfriTo').innerHTML = `<input name="n_dayAndTimeOfOperation_toTime_5" type="text" class="timepicker col s5" placeholder="End"
                               required>`;
        }
    }
    $('.timepicker').timepicker();
...
function saturday(isOffice) {
    if (isOffice) {
        ...
        if (OcboxSat.checked) {
            ...
            document.getElementById('OsatFrom').innerHTML = `<input type="text" name="n_dayAndTimeOfOperation_day_6" value="saturday" class="hide">
                        <input name="n_dayAndTimeOfOperation_fromTime_6" type="text" class="timepicker col s5"
                               placeholder="Start" required>`;
        }
        if (OcboxSat.checked) {
            ...
            document.getElementById('OsatTo').innerHTML = `<input name="n_dayAndTimeOfOperation_toTime_6" type="text" class="timepicker col s5"
                               placeholder="End" required>`;
        }
    }
    $('.timepicker').timepicker();
...
function sunday(isOffice) {
    if (isOffice) {
        ...
        if (OcboxSun.checked) {
            ...
            document.getElementById('OsunFrom').innerHTML = `<input type="text" name="n_dayAndTimeOfOperation_day_7" value="sunday" class="hide">
                        <input name="n_dayAndTimeOfOperation_fromTime_7" type="text" class="timepicker col s5"
                               placeholder="Start" required>`;
        }
        if (OcboxSun.checked) {
            ...
            document.getElementById('OsunTo').innerHTML = `<input name="n_dayAndTimeOfOperation_toTime_7" type="text" class="timepicker col s5" placeholder="End"
                               required>`;
        }
    }
    $('.timepicker').timepicker();
