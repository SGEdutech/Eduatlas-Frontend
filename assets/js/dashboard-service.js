...
async function initModules() {
	try {
		...
		promiseArr.push(userApiCalls.getAllResourses());

		const [forums, schedules, payments, registrationInfo, notificationsArr, reviewsArr, resoursesArr] =
